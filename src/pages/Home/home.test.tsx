...
const fn = jest.fn()
const contextValues = { data:intialData, currentPage:1, setCurtPage:fn, addCharacter:fn, favCharacters:[], setData:fn,setfavCharacters:fn};
...
describe("Search for StarWar character", ()=>{
    ...
    test('Should be able type in input and expect specfic star character on the page', async() => {
      const {findAllByTestId, getByPlaceholderText, findByText} = renderConnexion();
