      ...
      <div className="w-full flex justify-center mt-6 items-left">
        <nav aria-label="Page navigation example">
          <ul className="inline-flex -space-x-px">
            ...
            <li>
              <a className="bg-white border border-gray-300 text-gray-500 leading-tight py-2 px-3 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                {currentPage} / <b>9</b>
              </a>
            </li>
            <li>
